...
def compute_p2p_endpoint():
    ...
    try:
        ...
        frequency_mhz = float(req_data.get("frequency_mhz", 462.0)) # Default GMRS frequency
        ...
        # Wavelength in meters: c / f (c = 3e8 m/s, f in Hz)
        ...
        for i in range(num_samples):
            ...
            # Evaluation check based on user toggle
